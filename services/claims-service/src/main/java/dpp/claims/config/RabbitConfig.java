...
public class RabbitConfig {
    ...
    @Bean public Queue claimsPolicyIssuedQueue() { return quorumQueue("claims.policy.issued.queue", "PolicyIssued"); }
    ...
    @Bean public Queue claimsPolicyRenewedQueue() { return quorumQueue("claims.policy.renewed.queue", "PolicyRenewed"); }
    ...
    @Bean public Queue claimsPolicyCancelledQueue() { return quorumQueue("claims.policy.cancelled.queue", "PolicyCancelled"); }
    ...
    @Bean public Queue claimsEndorsementAppliedQueue() { return quorumQueue("claims.endorsement.applied.queue", "EndorsementApplied"); }
